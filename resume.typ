...
- #link("https://wjkoh.com/posts/view-dependent-adaptive-cloth-simulation/")[*View-Dependent Adaptive Cloth Simulation with Buckling Compensation*]. Woojong Koh, Rahul Narain, and James F. O'Brien. IEEE Transactions on Visualization and Computer Graphics (TVCG), October 2015.
